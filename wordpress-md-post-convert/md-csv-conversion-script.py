...
def parse_markdown(md_content):
    ...
    end_of_content = next((i for i, line in enumerate(lines) if line.startswith("Follow our Social Media")), len(lines))
    ...
    content = content.replace(f"SEO High-Ranking Page Tags: {tags}", "").strip()

    return title, content, tags

# Read the Markdown file content
md_content_path = 'E:/Github/orgs/ncgcloudhub/scripts/wordpress-md-post-convertadobefirefly.md'#'/mnt/data/file-UuGgKDfbcg3YQGVhC4CzNHhq'
...
csv_row = {
    ...
    "post_category": "Default Category",  # Replace with actual category provided by the user
    "post_tag": tags
}
...
mandatory_fields = ["post_title", "post_content", "post_name", "post_author", "post_category", "post_tag"]
